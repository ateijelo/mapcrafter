...
static const Biome BIOMES[] = {
    ...
    {0, 0.5, 0.5},                      // minecraft:ocean
    {1, 0.8, 0.4, one, default_water},  // minecraft:plains
    {2, 2.0, 0.0},                      // minecraft:desert
    {3, 0.2, 0.3},                      // minecraft:windswept_hills
    {4, 0.7, 0.8, one, default_water},  // minecraft:forest
    {5, 0.25, 0.8, one, default_water}, // minecraft:taiga
    {6, 0.8, 0.9, rgba(0x6a, 0x70, 0x39, 0xff), rgba(0x6A, 0x70, 0x39, 0xff)}, // minecraft:swamp
    {7, 0.5, 0.5, one, default_water},                                         // minecraft:river
    {8, 2.0, 0.0}, // minecraft:nether_wastes
    {9, 0.5, 0.5}, // minecraft:the_end

    {10, 0.0, 0.5, one, rgba(0x2b, 0x2a, 0x98, 0xff)}, // minecraft:frozen_ocean
    {11, 0.0, 0.5, one, rgba(0x2b, 0x2a, 0x98, 0xff)}, // minecraft:frozen_river
    {12, 0.0, 0.5},                                    // minecraft:snowy_plains
    {13, 0.0, 0.5},                      // Snowy Mountains           ? no id in the wiki
    {14, 0.9, 1.0},                      // minecraft:mushroom_fields
    {15, 0.9, 1.0},                      // Mushroom Island Shore     ? no id in the wiki
    {16, 0.8, 0.4, one, default_water},  // minecraft:beach
    ...
    {173, 0.8, 0.4, one, default_water}, // minecraft:basalt_deltas
    {174, 0.8, 0.4, one, default_water}, // minecraft:dripstone_caves
    {175, 0.8, 0.4, one, default_water}, // minecraft:lush_caves
    {177, 0.8, 0.4, one, default_water}, // minecraft:meadow
    {178, 0.8, 0.4, one, default_water}, // minecraft:grove
    {179, 0.8, 0.4, one, default_water}, // minecraft:snowy_slopes
...
// Biome getBiome(const std::string &name);
