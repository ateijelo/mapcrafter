...
Biome::Biome(uint16_t id, double temperature, double rainfall, uint32_t green_tint,
             uint32_t water_tint)
 ...
 */
uint16_t Biome::getID() const { return id; }
...
//     const auto it = biome_resource_ids.find(name);
