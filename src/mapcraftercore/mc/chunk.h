...
class Chunk {
  ...
  private:
    ...
    bool readNBT117(BlockStateRegistry &block_registry, const nbt::NBTFile &nbt);

    bool readNBT118(BlockStateRegistry &block_registry, const nbt::NBTFile &nbt);
};
